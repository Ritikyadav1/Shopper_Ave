  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "ritik@gmail.com" ? <div className="flow-root">
                 ...
                 {user?.user?.email === "ritik@gmail.com" ? <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://media.licdn.com/dms/image/v2/D4D03AQGTdSgkPTq66g/profile-displayphoto-shrink_400_400/B4DZb3ojPkG8Ak-/0/1747911325179?e=1753315200&v=beta&t=frFyyekuD3pgJxIlGRrnjl0e9SgzSdZBGlLsZdenqyM"
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-blue-400 px-4 text-sm font-medium text-gray-50 sm:px-6 lg:px-8" 
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Shopper Ave</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'ritik@gmail.com' ? 
               ...
               {user?.user?.email === 'ritik@gmail.com' ?  <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      className="inline-block w-10 h-10 rounded-full"
                      src="https://media.licdn.com/dms/image/v2/D4D03AQGTdSgkPTq66g/profile-displayphoto-shrink_400_400/B4DZb3ojPkG8Ak-/0/1747911325179?e=1753315200&v=beta&t=frFyyekuD3pgJxIlGRrnjl0e9SgzSdZBGlLsZdenqyM"
